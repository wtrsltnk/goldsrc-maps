...
bool    ImGui_ImplGlfwGL3_Init(GLFWwindow* window, bool install_callbacks)
{
    ...
    io.SetClipboardTextFn = (void (*)(void* user_data, const char* text))ImGui_ImplGlfwGL3_SetClipboardText;
    io.GetClipboardTextFn = (const char* (*)(void* user_data))ImGui_ImplGlfwGL3_GetClipboardText;
#ifdef _WIN32
